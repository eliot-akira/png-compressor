 ...
 */
export function assertChunkDataLengthEquals(
 ...
 * @param expected The expected data length of the chunk.
 */
export function assertChunkDataLengthGte(
  ctx: IDecodeContext,
  chunk: IPngChunk,
  expected: number,
) {
 ...
 */
export function assertChunkPrecedes(
  ctx: IDecodeContext,
  chunk: IPngChunk,
  typeAfter: KnownChunkTypes,
) {
 ...
 * @param typeAfter The chunk type that `type` must precede.
 */
export function assertChunkFollows(
  ctx: IDecodeContext,
  chunk: IPngChunk,
  typeAfter: KnownChunkTypes,
) {
 ...
 */
export function assertChunkMutualExclusion(
  ctx: IDecodeContext,
  chunk: IPngChunk,
  otherType: KnownChunkTypes,
) {
 ...
 */
export function assertChunkCompressionMethod(
  ctx: IInitialDecodeContext,
  chunk: IPngChunk,
...
export function createChunkDecodeError(
...
export function createChunkDecodeWarning(
  chunk: IPngChunk,
  message: string,
  offset: number,
): DecodeWarning {
