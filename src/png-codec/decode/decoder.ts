...
export { DecodeError, DecodeWarning }
 ...
 */
function getChunkDecoder(type: KnownChunkTypes): Promise<{
  parseChunk: (
    ctx: IDecodeContext,
  ...
  switch (type) {
    case KnownChunkTypes.bKGD:
      return import(`./chunks/chunk_bKGD.js`)
    case KnownChunkTypes.cHRM:
      return import(`./chunks/chunk_cHRM.js`)
    case KnownChunkTypes.eXIf:
      return import(`./chunks/chunk_eXIf.js`)
    case KnownChunkTypes.gAMA:
      return import(`./chunks/chunk_gAMA.js`)
    case KnownChunkTypes.hIST:
      return import(`./chunks/chunk_hIST.js`)
    case KnownChunkTypes.iCCP:
      return import(`./chunks/chunk_iCCP.js`)
    case KnownChunkTypes.iTXt:
      return import(`./chunks/chunk_iTXt.js`)
    case KnownChunkTypes.tIME:
      return import(`./chunks/chunk_tIME.js`)
    case KnownChunkTypes.oFFs:
      return import(`./chunks/chunk_oFFs.js`)
    case KnownChunkTypes.pCAL:
      return import(`./chunks/chunk_pCAL.js`)
    case KnownChunkTypes.pHYs:
      return import(`./chunks/chunk_pHYs.js`)
    case KnownChunkTypes.sBIT:
      return import(`./chunks/chunk_sBIT.js`)
    case KnownChunkTypes.sCAL:
      return import(`./chunks/chunk_sCAL.js`)
    case KnownChunkTypes.sPLT:
      return import(`./chunks/chunk_sPLT.js`)
    case KnownChunkTypes.sRGB:
      return import(`./chunks/chunk_sRGB.js`)
    case KnownChunkTypes.sTER:
      return import(`./chunks/chunk_sTER.js`)
    case KnownChunkTypes.tEXt:
      return import(`./chunks/chunk_tEXt.js`)
    case KnownChunkTypes.tRNS:
      return import(`./chunks/chunk_tRNS.js`)
    case KnownChunkTypes.zTXt:
      return import(`./chunks/chunk_zTXt.js`)
  ...
  for (let i = 1; i < chunks.length; i++) {
    ...
    switch (chunk.type) {
      case KnownChunkTypes.IHDR:
        handleWarning(
          ...
          createChunkDecodeWarning(
            ...
            chunk.offset + ChunkPartByteLength.Length,
          ),
        )
        break
      case KnownChunkTypes.IDAT: {
        ...
        while (
          chunks.length > i + 1 &&
          chunks[i + 1].type === KnownChunkTypes.IDAT
        ) {
      ...
      case KnownChunkTypes.PLTE:
        ctx.palette = (await import(`./chunks/chunk_PLTE.js`)).parseChunk(
          ctx,
          header,
          chunk,
        )
      ...
      default:
        if (parseChunkTypes.includes(chunk.type)) {
          try {
            ctx.metadata.push(
              (await getChunkDecoder(chunk.type as KnownChunkTypes)).parseChunk(
                ctx,
                header,
                chunk,
              ),
...
export function readChunks(ctx: IInitialDecodeContext): IPngChunk[] {
  ...
  while (offset < ctx.view.byteLength) {
    ...
    // 4B: CRC
    offset +=
      ChunkPartByteLength.Length +
      ChunkPartByteLength.Type +
      chunk.dataLength +
      ChunkPartByteLength.CRC
    chunks.push(chunk)
  ...
  if (chunks[0].type !== KnownChunkTypes.IHDR) {
    throw new DecodeError(
      ...
      chunks[0].offset + ChunkPartByteLength.Type,
    )
  }
  if (chunks[chunks.length - 1].type !== KnownChunkTypes.IEND) {
    handleWarning(
      ...
      new DecodeWarning(
        ...
        chunks[chunks.length - 1].offset + ChunkPartByteLength.Length,
      ),
    )
  }
  if (!hasData) {
...
export function readChunk(
  ...
  if (
    ctx.view.byteLength <
    offset + ChunkPartByteLength.Length + ChunkPartByteLength.Type
  ) {
  ...
  const expectedCrc = crc32(
    ...
    ChunkPartByteLength.Type + dataLength,
  )
