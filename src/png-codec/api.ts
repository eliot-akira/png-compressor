...
import type { DecodeError, DecodeWarning } from './decode/assert.ts'
import type { EncodeError, EncodeWarning } from './encode/assert.ts'
...
// export function decodePng(
//   data: Readonly<Uint8Array>,
//   options: IDecodePngOptions & { force32: true },
// ): Promise<IDecodedPng<IImage32>>
// export function decodePng(
//   data: Readonly<Uint8Array>,
//   options: IDecodePngOptions,
// ): Promise<IDecodedPng<IImage32 | IImage64>>

// export { decodePng } from './decode/decoder.ts'
...
// export { encodePng } from './encode/encoder.ts'
 ...
 */
export type DefaultParsedChunkTypes =
 ...
 */
export type OptionalParsedChunkTypes = Exclude<
  KnownChunkTypes,
