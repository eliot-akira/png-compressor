import {
  ...
  inflate as __inflate,
  inflateReset,
  inflateEnd,
} from './zlib/inflate.ts'
import { assign, flattenChunks } from './utils/common.ts'
import { string2buf, utf8border, buf2string } from './utils/strings.ts'
...
Inflate.prototype.push = function (data, flush_mode) {
  ...
  for (;;) {
    ...
    status = __inflate(strm, _flush_mode)
...
export * as constants from './zlib/constants.ts'
