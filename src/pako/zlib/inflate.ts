...
const _inflateReset = inflateReset
export { _inflateReset as inflateReset }
const _inflateReset2 = inflateReset2
export { _inflateReset2 as inflateReset2 }
const _inflateResetKeep = inflateResetKeep
export { _inflateResetKeep as inflateResetKeep }
const _inflateInit = inflateInit
export { _inflateInit as inflateInit }
const _inflateInit2 = inflateInit2
export { _inflateInit2 as inflateInit2 }
const _inflate = inflate
export { _inflate as inflate }
const _inflateEnd = inflateEnd
export { _inflateEnd as inflateEnd }
const _inflateGetHeader = inflateGetHeader
export { _inflateGetHeader as inflateGetHeader }
const _inflateSetDictionary = inflateSetDictionary
export { _inflateSetDictionary as inflateSetDictionary }
