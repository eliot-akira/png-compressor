...
const _deflateInit = deflateInit
export { _deflateInit as deflateInit }
const _deflateInit2 = deflateInit2
export { _deflateInit2 as deflateInit2 }
const _deflateReset = deflateReset
export { _deflateReset as deflateReset }
const _deflateResetKeep = deflateResetKeep
export { _deflateResetKeep as deflateResetKeep }
const _deflateSetHeader = deflateSetHeader
export { _deflateSetHeader as deflateSetHeader }
const _deflate = deflate
export { _deflate as deflate }
const _deflateEnd = deflateEnd
export { _deflateEnd as deflateEnd }
const _deflateSetDictionary = deflateSetDictionary
export { _deflateSetDictionary as deflateSetDictionary }
